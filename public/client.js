        ...
        function getAudioFeatures(idList){
            $.ajax({
                ...
                success: function(data) {
                    ...
                    features.forEach((vec, ii)=>{
                        stats['valence'].push(vec.valence)
                    })

                    console.log(stats)

                    //Call helper to plot
                    let histoID = '#audio_hist'
                    let plottingData  = stats['valence'];

            
                    plotAudioHist(plottingData);
                }
            });
